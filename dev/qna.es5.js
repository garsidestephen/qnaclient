...
var qnaClient = (function () {
    ...
    /// Init QNA Client
    ///
    var init = function init(ocpApimSubscriptionKey, urlKey, params) {
    ...
    function initEvents() {
        $launcher.on('click', function () {
            hideQnaLauncher();showQnaBot();
        });

        $closer.on('click', function () {
            hideQnaBot();showQnaLauncher();
        });
        ...
        if (question != null && question != "") {
            ...
            $.ajax({
                ...
                success: function success(data) {
                    parseResponse(data, callbackFn);
                },
                error: function error(XMLHttpRequest, textStatus, errorThrown) {
                    responseError(XMLHttpRequest, textStatus, errorThrown, callbackFn);
                }
            });
        }
    }
    ...
    return {
        Init: function Init(ocpApimSubscriptionKey, urlKey, params) {
            init(ocpApimSubscriptionKey, urlKey, params);
        }
    };
})();
