var qnaClient = (function () {
    ...
    function responseError(XMLHttpRequest, textStatus, errorThrown) { log(textStatus); clearInputAndFocus(); updateStream('Something went wrong, please ask your question again.', !0); hideBusy() }
